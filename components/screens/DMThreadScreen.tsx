...
export default function DMThreadScreen() {
  const { goBack, navigate, showToast, dmChar, dmHistory, dmTrust, sendDM, game, dmStorySession, screen, dmBadgeCount } = useApp()
  ...
  return (
    ...
    <div className={storySession ? 'dm-sheet-in' : undefined} style={{ display:'flex', flexDirection:'column', height:'100%' }}>
      ...
      <div className="tabbar">
        ...
        <button className="tab active" onClick={() => navigate('dm-inbox')} style={{ position: 'relative' }}>
