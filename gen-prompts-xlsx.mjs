...
const META = {
  ...
  kabir: { world: 'Creator House', name: 'Kabir', role: 'Comedy creator — secret antagonist',
    logic: 'The manipulator. "Neutral funny guy" mask over a drama-engineer with a receipts folder on everyone. PAST: he reposted Ananya\'s first video years ago and made her viral — her loyalty is his most reliable asset, and he exploits it. Trades gossip with Dev, circles Ria\'s top spot. Recruits the player as an asset before they read the game.' },
  meher: { world: 'Creator House', name: 'Meher', role: '(legacy — not in active cast)',
    logic: 'Unused in the live app (cast is ria/kabir/ananya/dev/zoya). Kept in the prompt file for possible future use.' },
  ria: { world: 'Creator House', name: 'Ria', role: 'Luxury creator — the queen / archrival',
    logic: 'The fragile queen at the top. Untouchable aesthetic funded by debt + wardrobe-return scam; the Luminary deal she frames as "the house\'s" is secretly hers. PAST (deep): she and Zoya were best friends who came up together until Ria took a shared deal alone — that betrayal is the engine of Zoya\'s revenge. Dev got close enough during a fake-romance content arc to suspect her finances.' },
  ananya: { world: 'Creator House', name: 'Ananya', role: 'Dance creator — the innocent',
    logic: 'The genuine one — no mask, the only emotions that are real. PAST: fiercely loyal to Kabir because he made her viral (she can\'t see he uses it). Zoya "mentors" her in a way that keeps her small. Notices things about Ria others miss. Decides trust fast and commits fully.' },
  dev: { world: 'Creator House', name: 'Dev', role: 'Fitness creator — transactional ally',
    logic: 'The deal-maker. Loyalty for sale, everything is collabs/numbers; secret debt, insecure about "dumb gym bro." PAST: ran a fake almost-romance arc with Ria for clout and got close to her real finances — unused leverage. Trades gossip with Kabir. Reliable ally only while the numbers work.' },
  zoya: { world: 'Creator House', name: 'Zoya', role: 'Beauty creator — sweet/sharp avenger',
    logic: 'The two-faced threat. Sweet on camera, ruthless off; secretly leaking to housewatch_india — aimed at Ria. PAST (deep): she and Ria were inseparable best friends until Ria took a deal meant for both and left her behind; she\'s never said how much it broke her. Keeps Ananya close and dependent. Plays the long game to make Ria irrelevant.' },
